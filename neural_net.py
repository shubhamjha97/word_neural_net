...
class Net:
	...
	def __init__(self, input_dimension, structure_dict): #!!!! FIX THIS
		...
		self.final_model.add(Dropout(0.5))
	...
	def train(self, train_X_1, train_X_2, train_y):
		self.final_model.fit([train_X_1, train_X_2], train_y, nb_epoch= 2,  batch_size=100, validation_split=0.33)

	def pred(self, word1, word2):
		return self.final_model.predict([word1, word2],  verbose=0)